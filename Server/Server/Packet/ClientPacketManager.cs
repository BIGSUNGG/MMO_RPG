...
class ClientPacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.CRequestObjectInfo, MakePacket<C_RequestObjectInfo>);
		_handler.Add((ushort)MsgId.CRequestObjectInfo, ClientPacketHandler.C_RequestObjectInfoHandler);		
		_onRecv.Add((ushort)MsgId.CResponseObjectSync, MakePacket<C_ResponseObjectSync>);
		_handler.Add((ushort)MsgId.CResponseObjectSync, ClientPacketHandler.C_ResponseObjectSyncHandler);		
